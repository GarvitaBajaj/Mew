...
create table mew.nodes (DeviceID varchar(30), battery double, linkspeed int(11), AccRunning boolean, AccPower double, GPSRunning boolean, GPSPower double, GyrRunning boolean, GyrPower double, SensorsAvailable int, servicingTask boolean, 
					old_lat double, old_lon double, new_lat double, new_lon double, providerMode boolean, MicPower double, WiFiPower double, BarRunning boolean, BarPower double, PPGRunning boolean, PpgPower double, Context int, ActivitiesRunning int, PRIMARY KEY (DeviceID));

-- NODES AUDIT TABLE
drop TABLE IF EXISTS nodes_audit;
create table mew.nodes_audit (DeviceID varchar(30), battery double, linkspeed int(11), AccRunning boolean, AccPower double, GPSRunning boolean, GPSPower double, GyrRunning boolean, GyrPower double, SensorsAvailable int, servicingTask boolean, 
                    old_lat double, old_lon double, new_lat double, new_lon double, providerMode boolean, MicPower double, WiFiPower double, BarRunning boolean, BarPower double, PPGRunning boolean, PpgPower double, Context int, ActivitiesRunning int,
                    Actions VARCHAR(8),
